    ...
    override fun apply(project: Project) {
        ...
        project.tasks {
            ...
            val addGithubCorner by register("githubCorner") {
                doLast {
                    addInIndex(githubCorner(project.name)) { text ->
...
fun githubCorner(name: String) = """
    <div class="pull-right d-flex">
        <a href="https://github.com/kotlin-graphics/$name/" class="github-corner" aria-label="View source on GitHub">
